...
//functions for special case elements, where an attribute or some other feature of the element determines how it should behave
	...
	function before_li($element,$index) {
	...
	function before_img($element,$index) {
	...
	function before_input($element,$index) {
	...
	function before_isindex($element,$index) {
	...
	function before_link($element,$index) {
	...
	function before_area($element,$index) {
		if( $element->hasAttribute('href') && ( $href = self::resolve($element->getAttribute('href'),$element) ) ) {
	...
	function before_form($element,$index) {
	...
	function before_quote($element,$index) {
	...
	function before_base($element,$index) {
	...
	function formattext($flags,$node_value) {
	...
	function render($element,$elementindex) {
